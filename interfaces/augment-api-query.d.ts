...
declare module '@polkadot/api-base/types/storage' {
    interface AugmentedQueries<ApiType extends ApiTypes> {
        assetRegistry: {
             ...
             * messages.
             **/
            locationToAssetId: AugmentedQuery<ApiType, (arg: StagingXcmV3MultiLocation | {
                parents?: any;
                interior?: any;
            } | string | Uint8Array) => Observable<Option<CurioKusamaRuntimeCommonCurrencyId>>, [StagingXcmV3MultiLocation]> & QueryableStorageEntry<ApiType, [StagingXcmV3MultiLocation]>;
            /**
             * The metadata of an asset, indexed by asset id.
             **/
            metadata: AugmentedQuery<ApiType, (arg: CurioKusamaRuntimeCommonCurrencyId | {
                Token: any;
            } | {
                DexShare: any;
            } | {
                ForeignAsset: any;
            } | string | Uint8Array) => Observable<Option<OrmlTraitsAssetRegistryAssetMetadata>>, [CurioKusamaRuntimeCommonCurrencyId]> & QueryableStorageEntry<ApiType, [CurioKusamaRuntimeCommonCurrencyId]>;
            /**
             * Generic query
             **/
        ...
        dex: {
             ...
             **/
            initialShareExchangeRates: AugmentedQuery<ApiType, (arg: PalletDexTradingPair) => Observable<ITuple<[u128, u128]>>, [PalletDexTradingPair]> & QueryableStorageEntry<ApiType, [PalletDexTradingPair]>;
            /**
             ...
             * Balance)
             **/
            provisioningPool: AugmentedQuery<ApiType, (arg1: PalletDexTradingPair, arg2: AccountId32 | string | Uint8Array) => Observable<ITuple<[u128, u128]>>, [PalletDexTradingPair, AccountId32]> & QueryableStorageEntry<ApiType, [PalletDexTradingPair, AccountId32]>;
            /**
        ...
        incentives: {
             ...
             **/
            claimRewardDeductionRates: AugmentedQuery<ApiType, (arg: PalletIncentivesPoolId | {
                Dex: any;
            } | string | Uint8Array) => Observable<u128>, [PalletIncentivesPoolId]> & QueryableStorageEntry<ApiType, [PalletIncentivesPoolId]>;
            /**
             ...
             **/
            incentiveRewardAmounts: AugmentedQuery<ApiType, (arg1: PalletIncentivesPoolId | {
                Dex: any;
            } | string | Uint8Array, arg2: CurioKusamaRuntimeCommonCurrencyId | {
                Token: any;
            } | {
                DexShare: any;
            } | {
                ForeignAsset: any;
            } | string | Uint8Array) => Observable<u128>, [PalletIncentivesPoolId, CurioKusamaRuntimeCommonCurrencyId]> & QueryableStorageEntry<ApiType, [PalletIncentivesPoolId, CurioKusamaRuntimeCommonCurrencyId]>;
            /**
             ...
             **/
            pendingMultiRewards: AugmentedQuery<ApiType, (arg1: PalletIncentivesPoolId | {
                Dex: any;
            } | string | Uint8Array, arg2: AccountId32 | string | Uint8Array) => Observable<BTreeMap<CurioKusamaRuntimeCommonCurrencyId, u128>>, [PalletIncentivesPoolId, AccountId32]> & QueryableStorageEntry<ApiType, [PalletIncentivesPoolId, AccountId32]>;
            /**
             * Generic query
             **/
            [key: string]: QueryableStorageEntry<ApiType>;
        ...
        rewards: {
             ...
             * map PoolId => PoolInfo
             **/
            poolInfos: AugmentedQuery<ApiType, (arg: PalletIncentivesPoolId | {
                Dex: any;
            } | string | Uint8Array) => Observable<OrmlRewardsPoolInfo>, [PalletIncentivesPoolId]> & QueryableStorageEntry<ApiType, [PalletIncentivesPoolId]>;
            /**
             ...
             **/
            sharesAndWithdrawnRewards: AugmentedQuery<ApiType, (arg1: PalletIncentivesPoolId | {
                Dex: any;
            } | string | Uint8Array, arg2: AccountId32 | string | Uint8Array) => Observable<ITuple<[u128, BTreeMap<CurioKusamaRuntimeCommonCurrencyId, u128>]>>, [PalletIncentivesPoolId, AccountId32]> & QueryableStorageEntry<ApiType, [PalletIncentivesPoolId, AccountId32]>;
            /**
             * Generic query
             **/
            [key: string]: QueryableStorageEntry<ApiType>;
        ...
        tokens: {
             ...
             * balances.
             **/
            accounts: AugmentedQuery<ApiType, (arg1: AccountId32 | string | Uint8Array, arg2: CurioKusamaRuntimeCommonCurrencyId | {
                Token: any;
            } | {
                DexShare: any;
            } | {
                ForeignAsset: any;
            } | string | Uint8Array) => Observable<OrmlTokensAccountData>, [AccountId32, CurioKusamaRuntimeCommonCurrencyId]> & QueryableStorageEntry<ApiType, [AccountId32, CurioKusamaRuntimeCommonCurrencyId]>;
            /**
             * Any liquidity locks of a token type under an account.
             * NOTE: Should only be accessed when setting, changing and freeing a lock.
             **/
            locks: AugmentedQuery<ApiType, (arg1: AccountId32 | string | Uint8Array, arg2: CurioKusamaRuntimeCommonCurrencyId | {
                Token: any;
            } | {
                DexShare: any;
            } | {
                ForeignAsset: any;
            } | string | Uint8Array) => Observable<Vec<OrmlTokensBalanceLock>>, [AccountId32, CurioKusamaRuntimeCommonCurrencyId]> & QueryableStorageEntry<ApiType, [AccountId32, CurioKusamaRuntimeCommonCurrencyId]>;
            /**
             * Named reserves on some account balances.
             **/
            reserves: AugmentedQuery<ApiType, (arg1: AccountId32 | string | Uint8Array, arg2: CurioKusamaRuntimeCommonCurrencyId | {
                Token: any;
            } | {
                DexShare: any;
            } | {
                ForeignAsset: any;
            } | string | Uint8Array) => Observable<Vec<OrmlTokensReserveData>>, [AccountId32, CurioKusamaRuntimeCommonCurrencyId]> & QueryableStorageEntry<ApiType, [AccountId32, CurioKusamaRuntimeCommonCurrencyId]>;
            /**
             * The total issuance of a token type.
             **/
            totalIssuance: AugmentedQuery<ApiType, (arg: CurioKusamaRuntimeCommonCurrencyId | {
                Token: any;
            } | {
                DexShare: any;
            } | {
                ForeignAsset: any;
            } | string | Uint8Array) => Observable<u128>, [CurioKusamaRuntimeCommonCurrencyId]> & QueryableStorageEntry<ApiType, [CurioKusamaRuntimeCommonCurrencyId]>;
            /**
             * Generic query
             **/
            [key: string]: QueryableStorageEntry<ApiType>;
        ...
        unknownTokens: {
             ...
             **/
            abstractFungibleBalances: AugmentedQuery<ApiType, (arg1: StagingXcmV3MultiLocation | {
                parents?: any;
                interior?: any;
            } | string | Uint8Array, arg2: Bytes | string | Uint8Array) => Observable<u128>, [StagingXcmV3MultiLocation, Bytes]> & QueryableStorageEntry<ApiType, [StagingXcmV3MultiLocation, Bytes]>;
            /**
             ...
             * double_map: who, asset_id => u128
             **/
            concreteFungibleBalances: AugmentedQuery<ApiType, (arg1: StagingXcmV3MultiLocation | {
                parents?: any;
                interior?: any;
            } | string | Uint8Array, arg2: StagingXcmV3MultiLocation | {
                parents?: any;
                interior?: any;
            } | string | Uint8Array) => Observable<u128>, [StagingXcmV3MultiLocation, StagingXcmV3MultiLocation]> & QueryableStorageEntry<ApiType, [StagingXcmV3MultiLocation, StagingXcmV3MultiLocation]>;
            /**
             * Generic query
             **/
            [key: string]: QueryableStorageEntry<ApiType>;
