...
declare module '@polkadot/api-base/types/events' {
    interface AugmentedEvents<ApiType extends ApiTypes> {
        ...
        dex: {
             ...
             **/
            DisableTradingPair: AugmentedEvent<ApiType, [tradingPair: PalletDexTradingPair], {
                tradingPair: PalletDexTradingPair;
            }>;
            /**
             * Enable trading pair.
             **/
            EnableTradingPair: AugmentedEvent<ApiType, [tradingPair: PalletDexTradingPair], {
                tradingPair: PalletDexTradingPair;
            }>;
            /**
             * List provisioning trading pair.
             **/
            ListProvisioning: AugmentedEvent<ApiType, [tradingPair: PalletDexTradingPair], {
                tradingPair: PalletDexTradingPair;
            }>;
            /**
             * Provisioning trading pair aborted.
             **/
            ProvisioningAborted: AugmentedEvent<ApiType, [tradingPair: PalletDexTradingPair, accumulatedProvision0: u128, accumulatedProvision1: u128], {
                tradingPair: PalletDexTradingPair;
             ...
             **/
            ProvisioningToEnabled: AugmentedEvent<ApiType, [tradingPair: PalletDexTradingPair, pool0: u128, pool1: u128, shareAmount: u128], {
                tradingPair: PalletDexTradingPair;
                pool0: u128;
                pool1: u128;
                shareAmount: u128;
        ...
        incentives: {
             ...
             **/
            ClaimRewardDeductionRateUpdated: AugmentedEvent<ApiType, [pool: PalletIncentivesPoolId, deductionRate: u128], {
        ...
        pausing: {
             ...
             **/
            EvmPrecompilePaused: AugmentedEvent<ApiType, [address: H160], {
                address: H160;
            }>;
            /**
             * Unpaused EVM precompile
             **/
            EvmPrecompileUnpaused: AugmentedEvent<ApiType, [address: H160], {
                address: H160;
            }>;
            /**
             * Paused transaction
             **/
            TransactionPaused: AugmentedEvent<ApiType, [palletNameBytes: Bytes, functionNameBytes: Bytes], {
             ...
             **/
            TransactionUnpaused: AugmentedEvent<ApiType, [palletNameBytes: Bytes, functionNameBytes: Bytes], {
                palletNameBytes: Bytes;
                functionNameBytes: Bytes;
            }>;
            /**
